...
configure:
	...
	echo "WITH_UNIT_TESTS = $(WITH_UNIT_TESTS)" >> $(BUILD_CONFIG_FILE)
	...
	echo "CC = $(CC)" >> $(BUILD_CONFIG_FILE)
	echo "CXX = $(CXX)" >> $(BUILD_CONFIG_FILE)
	echo "LD = $(LD)" >> $(BUILD_CONFIG_FILE)
	echo "PKG_CONFIG = $(PKG_CONFIG)" >> $(BUILD_CONFIG_FILE)
