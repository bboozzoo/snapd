...
// UpdateManagedConfig updates managed boot config assets if those are present.
// Returns true when an update was carried out.
func UpdateManagedConfig(dev Device) (updated bool, err error) {
	if !dev.HasModeenv() {
