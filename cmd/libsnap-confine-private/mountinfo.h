 ...
 **/
void sc_cleanup_mountinfo(struct sc_mountinfo **ptr) __attribute__((nonnull(1)));
 ...
 **/
struct sc_mountinfo_entry *sc_first_mountinfo_entry(struct sc_mountinfo *info) __attribute__((nonnull(1)));
 ...
 **/
struct sc_mountinfo_entry *sc_next_mountinfo_entry(struct sc_mountinfo_entry *entry) __attribute__((nonnull(1)));
