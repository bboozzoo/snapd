...
static void test_verify_security_tag(void) {
    ...
    g_assert_true(verify_security_tag("snap.network-manager.NetworkManager", "network-manager"));
    ...
    g_assert_true(verify_security_tag("snap.foo_instance.bar-baz", "foo_instance"));
    g_assert_true(verify_security_tag("snap.foo_instance.hook.bar-baz", "foo_instance"));
    g_assert_true(verify_security_tag("snap.foo_bar.hook.bar-baz", "foo_bar"));

    // Now, test the names we know are bad
    g_assert_false(verify_security_tag("pkg-foo.bar.0binary-bar+baz", "bar"));
    ...
    g_assert_false(verify_security_tag("snap.foo_toolonginstance.bar-baz", "foo"));
    g_assert_false(verify_security_tag("snap.foo_inst@nace.bar-baz", "foo"));
    g_assert_false(verify_security_tag("snap.foo_in-stan-ce.bar-baz", "foo"));
    ...
    g_assert_true(verify_security_tag("snap.123test.hook.configure", "123test"));
}
...
static void test_sc_snap_split_instance_name_short_instance_dest(void) {
    if (g_test_subprocess()) {
        char dest[10] = {0};
        sc_snap_split_instance_name("foo_barbarbarbar", NULL, 0, dest, sizeof dest);
        g_test_fail();
        return;
    }
    g_test_trap_subprocess(NULL, 0, 0);
...
static void test_sc_snap_split_instance_name_basic(void) {
    ...
    sc_snap_split_instance_name("foo-bar_bar", name, sizeof name, instance, sizeof instance);
    g_assert_cmpstr(name, ==, "foo-bar");
    g_assert_cmpstr(instance, ==, "bar");

    memset(name, 0xff, sizeof name);
    memset(instance, 0xff, sizeof instance);
    sc_snap_split_instance_name("foo-bar", name, sizeof name, instance, sizeof instance);
    g_assert_cmpstr(name, ==, "foo-bar");
    g_assert_cmpstr(instance, ==, "");

    memset(name, 0xff, sizeof name);
    memset(instance, 0xff, sizeof instance);
    sc_snap_split_instance_name("_baz", name, sizeof name, instance, sizeof instance);
    g_assert_cmpstr(name, ==, "");
    g_assert_cmpstr(instance, ==, "baz");

    memset(name, 0xff, sizeof name);
    memset(instance, 0xff, sizeof instance);
    sc_snap_split_instance_name("foo", name, sizeof name, instance, sizeof instance);
    g_assert_cmpstr(name, ==, "foo");
    g_assert_cmpstr(instance, ==, "");
    ...
    memset(instance, 0xff, sizeof instance);
    sc_snap_split_instance_name("foo_bar", NULL, 0, instance, sizeof instance);
    g_assert_cmpstr(instance, ==, "bar");

    memset(name, 0xff, sizeof name);
    memset(instance, 0xff, sizeof instance);
    sc_snap_split_instance_name("hello_world_surprise", name, sizeof name, instance, sizeof instance);
    g_assert_cmpstr(name, ==, "hello");
    g_assert_cmpstr(instance, ==, "world_surprise");

    memset(name, 0xff, sizeof name);
    memset(instance, 0xff, sizeof instance);
    sc_snap_split_instance_name("", name, sizeof name, instance, sizeof instance);
    g_assert_cmpstr(name, ==, "");
    g_assert_cmpstr(instance, ==, "");

    memset(name, 0xff, sizeof name);
    memset(instance, 0xff, sizeof instance);
    sc_snap_split_instance_name("_", name, sizeof name, instance, sizeof instance);
    g_assert_cmpstr(name, ==, "");
    g_assert_cmpstr(instance, ==, "");

    memset(name, 0xff, sizeof name);
    memset(instance, 0xff, sizeof instance);
    sc_snap_split_instance_name("foo_", name, sizeof name, instance, sizeof instance);
    g_assert_cmpstr(name, ==, "foo");
    g_assert_cmpstr(instance, ==, "");
}
...
static void __attribute__((constructor)) init(void) {
    ...
    g_test_add_func("/snap/sc_snap_split_instance_name/trailing_nil", test_sc_snap_split_instance_name_trailing_nil);
