...
//
// For example, with path: "/foo/bar/froz/baz" and depth 2 the result is:
...
// in /foo/bar/ or 3) the file froz/ in /foo/bar/. Subsequently, but just
// inside the directory /foo/bar/froz/ we can create any file, any directory
// or the file baz. Technically the last rule has some redundancy as baz is
// covered by * but this is retained for consistence.
//
